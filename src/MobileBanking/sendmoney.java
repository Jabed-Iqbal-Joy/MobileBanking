...
//import static MobileBanking.pin.ans;
...
public class sendmoney extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 25, 60, 40));
    ...
    private void send_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_send_btnActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (balance >= ttbalance && ttbalance > 100) {
                    jPanel3.hide();
                    jPanel5.show();
                    jPanel6.show();
            ...
            if (rs.next()) {
                ...
                if (newpin.equals(pin)) {
                    ...
                    try {
                        ...
                        update = (PreparedStatement) conn.prepareStatement("update customer_balance set balance=? where mobile=?");
                        update.setInt(1, (rbalance + ttbalance));
                        update.setString(2, mobile_num);
                        update.executeUpdate();
                    } catch (SQLException ex) {
                        Logger.getLogger(sendmoney.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    ...
                    JOptionPane.showMessageDialog(this, "Send Money Succesfull");
